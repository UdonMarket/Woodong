							...
							<div class="my_profile_left">
								...
								<div class="my_profile_nav">
									<ul style="background-color: #FFF; border: 1px solid #d9d9d9;">
										...
										<li><a class="active" id="scrollMain" href="/m/level.hm"><span
										...
										<li><a class="active" id="scrollMain"
											href="../mypage/myProfile.woo"><span
												style="font-size: 1.4em; color: #ff4f4f;">회원설정</span></a></li>
										<li><a href="../member/memberModify.woo"><span>회원정보
													수정</span></a></li>
