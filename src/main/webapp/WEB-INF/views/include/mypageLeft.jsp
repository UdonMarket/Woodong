...
<!-- breadcrumb part start-->
		<section class="breadcrumb_part" >
	      <div class="container-fluid">
	         ...
	         <img src="../resources/img/나의우동.png" alt="" id="main" style="height: 100%; width: 100%">
	      </div>
	   </section>
		<!-- breadcrumb part end-->
										...
										<div class="my_profile_left">
											...
											<div class="my_profile_nav">
												<ul style="background-color:#FFF;border:1px solid #d9d9d9;">
													<li class="my_profile_m_nav">
														<a href="/s/@16128096?tab=item"><span>상품 <!-- -->0</span></a>
													</li>
													<li class="my_profile_m_nav">
													...
													<li>
														<a href="../mypage/myPage.woo?mode=deal&dealMode=sell"><span>거래중</span></a>
													</li>
													<li>
														<a href="../mypage/myPage.woo?mode=sell"><span>판매목록</span></a>
													</li>
													<li>
														<a href="../mypage/myPage.woo?mode=like"><span>관심목록</span></a>
													</li>
													<li>
													...
													<li>
														<a href="../member/memberModify.woo"><span>회원정보 수정</span></a>
													</li>
													<li>
