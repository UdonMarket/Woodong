	        ...
	        <div class="container">
	        	<div class="row">
	        		...
	        		<div style="display: inline;">
	        			<img src="../resources/img/product/map1.png" alt="" style="width: 45%;"/>
        			</div>
        			<div style="display: inline;">
	        			<img src="../resources/img/product/map1.png" alt="" style="width: 45%;"/>
        			</div>
...
<div class="col-lg-3">
	...
	<div class="my_profile_nav">
		<ul style="background-color:#FFF;border:1px solid #d9d9d9;">
			...
			<li>
		 		<a href="../mypage/myList.woo"><span>인기매물</span></a>
			</li>
			<li>
				<a href="../mypage/myProduct.woo"><span>의류(남성/여성/아동)</span></a>
			</li>
			<li>
				<a href="../mypage/myReview.woo"><span>가전/디지털</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>가구</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>스포츠</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>유아용품</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>뷰티/여성잡화</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>게임/도서</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>반려동물</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>기타</span></a>
			</li>
			<li>
				<a href="/m/profile"><span>삽니다</span></a>
			</li>
