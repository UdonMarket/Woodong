				...
				<div class="col-lg-9" style="padding-left: 300px;">
					<div class="login_part_form"
						...
						<div class="login_part_form_iner">
							<div
								style="color: #ff4f4f; font-weight: bold; text-align: center; font-size: 2.5em; margin-bottom: 20px;">아이디
								찾기</div>

							<div style="margin-bottom: 10px;">
								<form:form class="row contact_form"
									action="../member/joinAction.woo" method="post" name="joinFrm"
									id="joinFrm" onsubmit="return frmCheck(this);">
											...
											<ul>
												...
												<li>
													...
													<div class="row">
														...
														<button hidden="hidden" type="button"
															class="btn btn-primary" data-toggle="modal"
															data-target="#myModal4" id="mo4" alt="인증번호 입력요구"></button>
													</div>
												</li>
												<!-- <li>
												<div>수신설정</div>
	...
	<div class="modal fade" id="myModal4">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<!-- Modal Header -->
				<div class="modal-header" id="modal_head">
					<h4 class="modal-title">인증번호 입력</h4>
					<div style="text-align: right; margin-right: 30px;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
				</div>
				...
				<!-- Modal body -->
				<div class="modal-body" id="modal_res3">인증번호를 입력해주세요</div>
