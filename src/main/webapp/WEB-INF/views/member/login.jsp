            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-9" style="padding-left:300px;">
                    <div class="login_part_form" style="border: 1px solid #d9d9d9;">
                        ...
                        <div style="color:#ff4f4f; font-weight:bold; text-align:center; font-size:3.0em;margin-bottom:60px;">로그인</div>
                            
                            <div style="margin-bottom:10px;">
                              <c:url value="/loginAction" var="loginUrl"/>
                           <form:form name="loginFrm"  class="row contact_form" action="${loginUrl }" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="single-input-primary" id="name" name="name" value=""
                                        placeholder="아이디" style="border-bottom: 1px solid gray;">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="single-input-primary" id="password" name="password" value=""
                                        placeholder="비밀번호" style="border-bottom: 1px solid gray;">
                                </div>
