...
<body>
	...
	<section class="left_main"
		...
		<div class="cat_box"><div class="my_specialist_name">	<span></span> 	</div></div>
		...
		<div class="tab_content">
					...
					<ul class="mian_row profile_main_row">
						<c:choose>
							<c:when test="${empty likeList}">
								<li><span style="font-size: 20px; padding-left: 250px;">게시물이 없습니다.</span>
									<div class="row" style="padding-top: 50px; padding-left: 50px; padding-bottom: 50px; border-bottom: 1px solid #d9d9d9;">
										<div class="col-3"><div class="member_image_box1"></div></div>
										<div class="col-1"></div>
										<div class="member_box col-8"></div>	</div></li>
							</c:when>
							<c:otherwise>
								<c:forEach var="list" items="${likeList }">
									<li class="main_col_3" style="padding: 5px">
									<a class="card card_list" 	href="/item/166608634?viewPath=wish_list&amp;clickPath=member"></a>
										<div class="card_box">
												...
												<div class="image_outside">
													<div class="image_centerbox">
														<a href="javascript:void(0);" onclick="ajaxView(${list.boardidx});"> 
															...
															data-src="https://ccimg.hellomarket.com/images/2020/item/04/28/15/1709868_4830039_1.jpg?size=s4" class="thumbnail_img" />
														</div>
														<div class="dealer_text_position"></div>
													</div>
												</div>
											<div class="cont">
												<div class="item_title related_item_icon">${list.title }</div></a>
			...
			<div class="paging"><ul>${pagingImg }</ul></div>
			</div>
		</div>
	</section>
	</div>
