...
.placeinfo_wrap {position:absolute;bottom:180px;left:-180px;width:300px;}
...
<div class="map_wrap">
	...
	function addMarker(position, order) {
	    var imageSrc = '../resources/img/map/지도마커1-2.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
	        imageSize = new kakao.maps.Size(50),  // 마커 이미지의 크기
	        imgOptions =  {
	            spriteSize : new kakao.maps.Size(50), // 스프라이트 이미지의 크기
