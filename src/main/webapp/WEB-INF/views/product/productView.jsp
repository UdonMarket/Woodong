														...
														<c:forEach var="uploadFile" items="${uploadFileList}" varStatus="status">
															...
															<c:if test="${!status.first}">
																<div class="carousel-item">
																	<img src="../resources/Upload/${uploadFile.save_name}"
													...
													<div class="row">
														<div class="item_title_area col-12">
															<span class="item_tag">
																...
																<span class="wish_box">
																	<img src="https://ccimage.hellomarket.com/web/2020/item/ico_zzim_24x23_s_x2.png" alt="찜하기이미지" class="wish_icon"> <label>${viewRow.likecount}</label>
																</span>
															</span>
														</div>
													</div>
															...
															<div class="row" style="margin-top: 60px">
																...
																<div class="col-4" style="padding: 0px;">
																	<c:if test="${viewRow.three_dimens eq 'Y'}">
																		<img src="../resources/img/product/3d 이미지.png" data-toggle="modal" data-target="#myModal" style="width: 125px; height: 65px; margin-left: 8px;" />
																	</c:if>
																</div>
											...
											<div class="col-4">
												<div class="row">
													<div class="col-12" style="text-align: right">
														<c:if test="${viewRow.id eq user_id}">
												...
												<div class="row">
													<div class="col-12"
														style="border: 1px solid #d9d9d9; width: 200px; height: 300px;">
														<div class="my_profile_info ">
															<div class="row">
																...
																<div class="my_profile_image col-6"
																	...
																	<a
																		href="../mypage/myPage.woo?mode=review&dealPosition=seller&seller_id=${viewRow.id}&">${udongGrade }</a>
																</div>
																<div class="col-3"></div>
															</div>
															<div class="my_profile_nick"
																style="text-align: center; font-size: 18px; font-weight: bold; padding-bottom: 5px; padding-top: 5px;">판매자
																: ${viewRow.id}</div>
																	...
																	<a href="../main/write.woo">
																		<div class="my_profile_pro_review">
																			<div class="my_profile_pro_review_rating"
																				style="white-space: nowrap; width: 40px; height: 20px; padding-left: 20px;">
																				<span style="padding-left: 10px; font-size: 15px;">거래후기
																					: <span style="font-weight: bold;">${memberVO.avg_score}개</span>
																					&nbsp;
																				</span>${score} <br /> <span
																					style="font-size: 15px; padding-left: 10px;">거래횟수
																					: <span
																					style="font-weight: bold; font-size: 15px;">${memberVO.trade_count}
																						번</span>
																				</span>
																			</div>
		...
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!--3D .product-viewer   -->
					<div class="cd-product-viewer-wrapper" data-frame="8"
						data-friction="0.33">
						<div>
							...
							<div class="cd-product-viewer-handle">
								<span class="fill" style="transform: scaleX(1);"></span> <span
									class="handle">Handle</span>
							</div>
						</div>
					</div>
