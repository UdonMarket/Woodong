...
<head>
  ...
  <link rel="stylesheet" href="../resources/css/3d.css"> <!-- Resource style -->
</head>
<!-- head.jsp -->
		...
		<div class="item_list_area_box">
			<div class="breadcrumbs">
				<ul style="color: #ff4f4f;">
					...
					<li>
					<a href="./productList.woo?bname=${viewRow.bname}" style="color: #ff4f4f;">&gt;&nbsp;&nbsp;${viewRow.bname}</a></li>
				</ul>
			</div>
			<div class="main_area">
										...
										<div class="item_price_box item_price_box_bottom" style="width: none; height: 200px;">
											...
											<div class="detail_bottom_area1 detail_bottom_tag_area" style="margin-left: 10px;">
													<span class="tag" style="color: #ff4f4f;">
														...
														<a href="./productList.woo?searchField=product_tag&searchTxt=${item}"><button type="button" class="btn_ca">#${item}</button></a>
														</c:forTokens>
													</span>
												</div>
											</div>
...
<jsp:include page="../include/sidebar.jsp" />
	...
	<!-- The Modal start-->
	<div class="modal fade" id="myModal" style="top: 0; left: 0; margin-top: 100px;">
					...
					<div class="cd-product-viewer-wrapper" data-frame="8" data-friction="0.33">
						<div>
							<figure class="product-viewer">
								<img src="../resources/Upload/${tdimage}" alt="Product Preview" style="width: 550px; height: 500px; ">
								<div class="product-sprite" data-image="../resources/Upload/${tdimage}" 
